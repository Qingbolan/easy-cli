...
class CommandManager:
    ...
    def __init__(self, config_dir: Optional[Path] = None):
        self.config_dir = config_dir or (Path.home() / ".easycli")
...
"""
{cmd_name} - Custom EasyCli command
...
def main():
    from easycli.cli import ChatApplication
...
def setup_commands_interactive():
    ...
    console.print("\n[bold cyan]🚀 EasyCli Custom Command Setup[/bold cyan]\n")
